...
export const DATASET_MANIFEST = Object.freeze({
  ...
  "ttg-refinement": {
    ...
    status: DATASET_STATUS.VERIFIED,
    limitations: "Production is probabilistic; expected output is not guaranteed.",
    assumptions: ["The first refinement each day costs half and weekly attempts reset Monday."],
    experimental: [],
    version: "2026-09-06",
  },
  "pet-progression": {
  ...
  "master-progression": {
    ...
    source: "https://www.kingshotguide.org/data-center/kingshot-masters-database",
    lastVerified: "2026-09-06",
    status: DATASET_STATUS.VERIFIED,
    limitations: "Relationship milestone values are shared; skill planning is tracked independently.",
    assumptions: [],
    experimental: [],
    version: "2026-09-06",
  },
