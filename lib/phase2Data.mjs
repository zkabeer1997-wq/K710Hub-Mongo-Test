...
export const HERO_MASTERY_COSTS = Object.freeze(
  Array.from({ length: 20 }, (_, i) => ({
    level: i + 1,
    forgehammers: (i + 1) * 10,
    // Mastery 1-20 consumes Forgehammers only. Mythic Gear is used by Red
    // ascension/imbuement and is never part of Mastery forging or its reforge.
    mythicPieces: 0,
  })),
);
...
const governorRaw = [
  ...
  ["Gold T2", 38000, 360, 55, 1852320, 2.55, 9],
  ...
  ["Red T2 +3", 262000, 2620, 520, 3000000, 2.5, 16.5],
  ...
  ["Red T4", 366000, 3660, 730, 3330000, 2.75, 23],
  ["Red T4 +1", 384000, 3840, 770, 3396000, 2.75, 23],
  ["Red T4 +2", 403000, 4030, 810, 3462000, 2.75, 23],
  ["Red T4 +3", 423000, 4230, 850, 3528000, 2.75, 23],
  ["Red T5", 465000, 4650, 940, 3600000, 3, 26.5],
  ["Red T5 +1", 479000, 4790, 970, 3672000, 3, 26.5],
  ["Red T5 +2", 493000, 4930, 1000, 3744000, 3, 26.5],
  ["Red T5 +3", 508000, 5080, 1030, 3816000, 3, 26.5],
  ["Red T6", 549000, 5490, 1110, 3888000, 3, 30],
