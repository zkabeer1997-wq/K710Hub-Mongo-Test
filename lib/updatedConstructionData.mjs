...
export const CONSTRUCTION_SOURCE = Object.freeze({
  ...
  limitations: "True Gold and Tempered True Gold reproduce the workbook's full five-stage tier totals; its summary labels them approximate. Town Center secondary resources and base time are approximate through TG8. Exact per-substage costs were not supplied.",
});
