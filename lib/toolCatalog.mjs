...
const gearCosts = () => GOVERNOR_GEAR_TIER_COSTS.flatMap((cost,tier)=>cost ? [field(`cost.${tier}.g`,'Satin',cost[0],`Tier ${tier}`,0),field(`cost.${tier}.d`,'Gilded Threads',cost[1],`Tier ${tier}`,0)] : []);
