...
export const TOOL_CATALOG = {
 ...
 'governor-gear-sailing-tool': {label:'Governor Gear Sailing Tool',fields:[...gearCosts(),field('common.d','Gilded Threads',5,'Common chest'),field('premium.g','Satin',5,'Premium chest'),field('premium.d','Gilded Threads',10,'Premium chest'),field('exquisite.g','Satin',15,'Exquisite chest'),field('exquisite.d','Gilded Threads',15,'Exquisite chest'),field('exquisite.shards','Gear Fragments',2,'Exquisite chest',0),field('majestic.g','Satin',50,'Majestic chest'),field('majestic.d','Gilded Threads',50,'Majestic chest'),field('majestic.shards','Gear Fragments',6,'Majestic chest',0)]},
