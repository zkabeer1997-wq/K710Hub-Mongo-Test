...
export default function PetPackOptimizer({configuration, toolKey = 'pet-pack-optimizer'}) {
  ...
  return <section className="ppo-shell">
    ...
    <style>{`
      ...
      .ppo-pet-card>header button,.ppo-pet-grid>label,.ppo-pet-subtotal span,.ppo-calculated span,.ppo-calculated p,.ppo-panel-head>span,.ppo-readonly span,.ppo-override summary,.ppo-field,.ppo-shortfall span,.ppo-rule,.ppo-result-head dt,.ppo-redemption p,.ppo-redemption>span,.ppo-pack-group h4{font-size:11px}
      @media(max-width:580px){.ppo-pet-card>header button,.ppo-add-pet,.ppo-override summary{min-height:44px}}
