  ...
  return <div className={styles.shell}>
    ...
    <div className={styles.workspace}>
      ...
      <aside className={styles.results}>
        ...
        {plan.steps.length && state.refinement.targetDate ? <p className={styles.scheduleStatus}>{plan.refining.targetDateMet ? `This plan meets the ${state.refinement.targetDate} target date.` : `This plan does not meet the ${state.refinement.targetDate} target date with the current inputs.`}</p> : null}
